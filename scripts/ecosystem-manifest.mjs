...
if (check) {
  ...
  // `variants` (the web build a release ships beside the primary, recorded above
  // as informational) is stripped here with the rest, so a manifest written
