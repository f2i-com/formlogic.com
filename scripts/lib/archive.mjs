// Copied from softn.com/scripts/lib/archive.mjs (Apache-2.0), the writer every
// Softn release archive goes through, so FormLogic reads a release archive the
// same way Softn verified it. Keep in step with the Softn copy; no local edits.
