...
CREATE TABLE `flow_run_logs` (
  ...
  `parent_run_id` varchar(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `root_run_id` varchar(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `call_node_id` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  KEY `idx_frl_root` (`root_run_id`),
  KEY `idx_frl_parent` (`parent_run_id`),
...
CREATE TABLE `flow_definition_versions` (
  ...
  `compiled_ir_json` mediumtext COLLATE utf8mb4_unicode_ci,
  `definition_locks_json` mediumtext COLLATE utf8mb4_unicode_ci,
  `ir_digest` char(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `package_service_bindings` (
  `id` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `user_id` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `installation_id` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL,
