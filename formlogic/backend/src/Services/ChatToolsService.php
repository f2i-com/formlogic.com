            ...
            case 'blueprint_propose_elements': {
                ...
                try {
                    $result = $commit
                        ...
                        : $blueprints->validateOperations($userId, $blueprintId, $batch);
