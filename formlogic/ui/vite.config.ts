  ...
  plugins: [
    ...
    VitePWA({
      ...
      workbox: {
        ...
        // The zipp expression engine (ZIPP's web-python-base release, installed from the
        // Softn release) is 7.46 MB and is only needed by a form that
        ...
        //   would cost every visitor 7.46 MB up front, which is the worse trade.
        globIgnores: [
          'hosted-runtime/**',
          'app-editors/**',
          '**/esbuild-*.wasm',
