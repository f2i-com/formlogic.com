  ...
  plugins: [
    ...
    VitePWA({
      ...
      workbox: {
        ...
        // The zipp expression engine (ZIPP's web-python release, installed from the
        // Softn release) is 8.2 MB and is only needed by a form that
        ...
        //   would cost every visitor 8.2 MB up front, which is the worse trade.
        globIgnores: [
          'hosted-runtime/**',
          'app-editors/**',
          '**/esbuild-*.wasm',
