...
export function MobileNav() {
  ...
  const navItems = [
    ...
    // App-first: "+" goes straight to Create app (name it → App Studio). Forms,
    // flows and diagrams keep their own New buttons on their sections.
    { action: () => navigate('/apps/new'), icon: Plus, label: 'Create app', isAction: true },
