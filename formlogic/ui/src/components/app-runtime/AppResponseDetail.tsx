...
import { SignatureValue } from '../ui/SignatureValue';
                    ...
                    <div className="text-[15px] text-gray-900 dark:text-slate-100 break-words">
                      {answers[field.id] !== undefined && answers[field.id] !== null && answers[field.id] !== ''
                        ? (() => {
                            ...
                            // Signature: render the drawn image, or show the typed name (never
                            // the raw "typed:" prefix) — same renderer as the builder record view.
                            if (field.type === 'signature') {
                              return <SignatureValue value={val} />;
                            }
