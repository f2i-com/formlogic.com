    ...
    // ── 1. Event Registration ─────────────────────────────────────────────
    {
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          cols: 12,
          widgets: [
            { id: 'k1', title: 'Registrations', layout: { x: 0, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:event-registration', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k2', title: 'Organizations', layout: { x: 3, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:event-registration', viz: 'kpi', measure: { fn: 'countDistinct', field: 'organization' } } },
            { id: 'c1', title: 'By ticket type', layout: { x: 0, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:event-registration', viz: 'bar', groupBy: { field: 'ticket_type', bucket: 'none' }, measure: { fn: 'count' }, seriesSort: 'value', sort: 'desc', limit: 8 } },
            { id: 'c2', title: 'Registrations over time', layout: { x: 6, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:event-registration', viz: 'area', groupBy: { field: '__submitted_at', bucket: 'month' }, measure: { fn: 'count' }, seriesSort: 'label', limit: 12 } },
            { id: 'c3', title: 'Dietary requirements', layout: { x: 0, y: 4, w: 4, h: 3 }, kind: 'report', spec: { formId: '@pack:event-registration', viz: 'donut', groupBy: { field: 'dietary_requirements', bucket: 'none' }, measure: { fn: 'count' }, limit: 7 } },
            { id: 'l1', title: 'Recent registrations', layout: { x: 4, y: 4, w: 8, h: 3 }, kind: 'list', list: { formId: '@pack:event-registration', titleField: 'attendee_name', subtitleField: 'organization', limit: 6 } },
          ],
        },
      },
    },
    ...
    // ── 2. Speaker / Presenter Submission ─────────────────────────────────
    {
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          cols: 12,
          widgets: [
            { id: 'k1', title: 'Submissions', layout: { x: 0, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:speaker-submission', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k2', title: 'Unique speakers', layout: { x: 3, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:speaker-submission', viz: 'kpi', measure: { fn: 'countDistinct', field: 'email' } } },
            { id: 'c1', title: 'By presentation type', layout: { x: 0, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:speaker-submission', viz: 'bar', groupBy: { field: 'presentation_type', bucket: 'none' }, measure: { fn: 'count' }, seriesSort: 'value', sort: 'desc', limit: 8 } },
            { id: 'c2', title: 'Submissions over time', layout: { x: 6, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:speaker-submission', viz: 'area', groupBy: { field: '__submitted_at', bucket: 'month' }, measure: { fn: 'count' }, seriesSort: 'label', limit: 12 } },
            { id: 'c3', title: 'Equipment needs', layout: { x: 0, y: 4, w: 4, h: 3 }, kind: 'report', spec: { formId: '@pack:speaker-submission', viz: 'donut', groupBy: { field: 'equipment_needs', bucket: 'none' }, measure: { fn: 'count' }, limit: 6 } },
            { id: 'l1', title: 'Recent submissions', layout: { x: 4, y: 4, w: 8, h: 3 }, kind: 'list', list: { formId: '@pack:speaker-submission', titleField: 'speaker_name', subtitleField: 'topic_title', limit: 6 } },
          ],
        },
      },
    },
    ...
    // ── 3. Vendor / Exhibitor Application ─────────────────────────────────
    {
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          cols: 12,
          widgets: [
            { id: 'k1', title: 'Applications', layout: { x: 0, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:vendor-application', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k2', title: 'Companies', layout: { x: 3, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:vendor-application', viz: 'kpi', measure: { fn: 'countDistinct', field: 'company_name' } } },
            { id: 'c1', title: 'By booth size', layout: { x: 0, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:vendor-application', viz: 'bar', groupBy: { field: 'booth_size', bucket: 'none' }, measure: { fn: 'count' }, seriesSort: 'value', sort: 'desc', limit: 8 } },
            { id: 'c2', title: 'Applications over time', layout: { x: 6, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:vendor-application', viz: 'area', groupBy: { field: '__submitted_at', bucket: 'month' }, measure: { fn: 'count' }, seriesSort: 'label', limit: 12 } },
            { id: 'c3', title: 'Power requirements', layout: { x: 0, y: 4, w: 4, h: 3 }, kind: 'report', spec: { formId: '@pack:vendor-application', viz: 'donut', groupBy: { field: 'power_requirements', bucket: 'none' }, measure: { fn: 'count' }, limit: 6 } },
            { id: 'l1', title: 'Recent applications', layout: { x: 4, y: 4, w: 8, h: 3 }, kind: 'list', list: { formId: '@pack:vendor-application', titleField: 'company_name', subtitleField: 'contact_name', limit: 6 } },
          ],
        },
      },
    },
    ...
    // ── 4. Volunteer Sign-Up ──────────────────────────────────────────────
    {
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          cols: 12,
          widgets: [
            { id: 'k1', title: 'Volunteers', layout: { x: 0, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:volunteer-signup', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k2', title: 'Unique volunteers', layout: { x: 3, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:volunteer-signup', viz: 'kpi', measure: { fn: 'countDistinct', field: 'email' } } },
            { id: 'c1', title: 'Availability', layout: { x: 0, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:volunteer-signup', viz: 'bar', groupBy: { field: 'availability', bucket: 'none' }, measure: { fn: 'count' }, seriesSort: 'value', sort: 'desc', limit: 8 } },
            { id: 'c2', title: 'Sign-ups over time', layout: { x: 6, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:volunteer-signup', viz: 'area', groupBy: { field: '__submitted_at', bucket: 'month' }, measure: { fn: 'count' }, seriesSort: 'label', limit: 12 } },
            { id: 'c3', title: 'Skills & interests', layout: { x: 0, y: 4, w: 4, h: 3 }, kind: 'report', spec: { formId: '@pack:volunteer-signup', viz: 'donut', groupBy: { field: 'skills', bucket: 'none' }, measure: { fn: 'count' }, limit: 6 } },
            { id: 'l1', title: 'Recent sign-ups', layout: { x: 4, y: 4, w: 8, h: 3 }, kind: 'list', list: { formId: '@pack:volunteer-signup', titleField: 'volunteer_name', subtitleField: 'email', limit: 6 } },
          ],
        },
      },
    },
    ...
    // ── 5. Post-Event Feedback ────────────────────────────────────────────
    {
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          cols: 12,
          widgets: [
            { id: 'k1', title: 'Responses', layout: { x: 0, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:event-feedback', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k2', title: 'Avg overall rating', layout: { x: 3, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:event-feedback', viz: 'kpi', measure: { fn: 'avg', field: 'overall_rating' } } },
            { id: 'k3', title: 'Avg venue', layout: { x: 6, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:event-feedback', viz: 'kpi', measure: { fn: 'avg', field: 'venue_rating' } } },
            { id: 'k4', title: 'Avg speakers', layout: { x: 9, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:event-feedback', viz: 'kpi', measure: { fn: 'avg', field: 'speakers_rating' } } },
            { id: 'c1', title: 'Would attend again', layout: { x: 0, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:event-feedback', viz: 'bar', groupBy: { field: 'would_attend_again', bucket: 'none' }, measure: { fn: 'count' }, seriesSort: 'value', sort: 'desc', limit: 6 } },
            { id: 'c2', title: 'Would recommend', layout: { x: 6, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:event-feedback', viz: 'donut', groupBy: { field: 'would_recommend', bucket: 'none' }, measure: { fn: 'count' }, limit: 5 } },
            { id: 'l1', title: 'Recent feedback', layout: { x: 0, y: 4, w: 12, h: 3 }, kind: 'list', list: { formId: '@pack:event-feedback', titleField: 'attendee_record', subtitleField: 'would_recommend', limit: 6 } },
          ],
        },
      },
    },
    ...
    // ── 6. Event Incident Log ─────────────────────────────────────────────
    {
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          cols: 12,
          widgets: [
            { id: 'k1', title: 'Incidents', layout: { x: 0, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:event-incident-log', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k2', title: 'Locations', layout: { x: 3, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:event-incident-log', viz: 'kpi', measure: { fn: 'countDistinct', field: 'location' } } },
            { id: 'c1', title: 'By incident type', layout: { x: 0, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:event-incident-log', viz: 'bar', groupBy: { field: 'incident_type', bucket: 'none' }, measure: { fn: 'count' }, seriesSort: 'value', sort: 'desc', limit: 8 } },
            { id: 'c2', title: 'By severity', layout: { x: 6, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:event-incident-log', viz: 'donut', groupBy: { field: 'severity', bucket: 'none' }, measure: { fn: 'count' }, limit: 4 } },
            { id: 'c3', title: 'Incidents over time', layout: { x: 0, y: 4, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:event-incident-log', viz: 'area', groupBy: { field: 'incident_date', bucket: 'month' }, measure: { fn: 'count' }, seriesSort: 'label', limit: 12 } },
            { id: 'l1', title: 'Recent incidents', layout: { x: 6, y: 4, w: 6, h: 3 }, kind: 'list', list: { formId: '@pack:event-incident-log', titleField: 'incident_type', subtitleField: 'location', limit: 6 } },
          ],
        },
      },
    },
    ...
    // ── 7. Event Budget Item ──────────────────────────────────────────────
    {
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          cols: 12,
          widgets: [
            { id: 'k1', title: 'Line items', layout: { x: 0, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:budget-tracker', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k2', title: 'Estimated total', layout: { x: 3, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:budget-tracker', viz: 'kpi', measure: { fn: 'sum', field: 'estimated_cost' } } },
            { id: 'k3', title: 'Actual total', layout: { x: 6, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:budget-tracker', viz: 'kpi', measure: { fn: 'sum', field: 'actual_cost' } } },
            { id: 'c1', title: 'Estimated by category', layout: { x: 0, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:budget-tracker', viz: 'bar', groupBy: { field: 'category', bucket: 'none' }, measure: { fn: 'sum', field: 'estimated_cost' }, seriesSort: 'value', sort: 'desc', limit: 10 } },
            { id: 'c2', title: 'Actual by category', layout: { x: 6, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:budget-tracker', viz: 'bar', groupBy: { field: 'category', bucket: 'none' }, measure: { fn: 'sum', field: 'actual_cost' }, seriesSort: 'value', sort: 'desc', limit: 10 } },
            { id: 'c3', title: 'Estimated share', layout: { x: 0, y: 4, w: 4, h: 3 }, kind: 'report', spec: { formId: '@pack:budget-tracker', viz: 'donut', groupBy: { field: 'category', bucket: 'none' }, measure: { fn: 'sum', field: 'estimated_cost' }, limit: 10 } },
            { id: 'l1', title: 'Recent line items', layout: { x: 4, y: 4, w: 8, h: 3 }, kind: 'list', list: { formId: '@pack:budget-tracker', titleField: 'item_name', subtitleField: 'category', limit: 6 } },
          ],
        },
      },
    },
  ...
  apps: [
    {
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          widgets: [
            { id: 'k1', title: 'Registrations', layout: { x: 0, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:event-registration', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k2', title: 'Speakers', layout: { x: 3, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:speaker-submission', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k3', title: 'Vendors', layout: { x: 6, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:vendor-application', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k4', title: 'Volunteers', layout: { x: 9, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:volunteer-signup', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'c1', title: 'Registrations over time', layout: { x: 0, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:event-registration', viz: 'area', groupBy: { field: '__submitted_at', bucket: 'month' }, measure: { fn: 'count' }, seriesSort: 'label', limit: 12 } },
            { id: 'c2', title: 'Registrations by ticket type', layout: { x: 6, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:event-registration', viz: 'bar', groupBy: { field: 'ticket_type', bucket: 'none' }, measure: { fn: 'count' }, seriesSort: 'value', sort: 'desc', limit: 8 } },
            { id: 'c3', title: 'Budget by category', layout: { x: 0, y: 4, w: 8, h: 3 }, kind: 'report', spec: { formId: '@pack:budget-tracker', viz: 'bar', groupBy: { field: 'category', bucket: 'none' }, measure: { fn: 'sum', field: 'estimated_cost' }, seriesSort: 'value', sort: 'desc', limit: 10 } },
            { id: 'ac1', title: 'Recent activity', layout: { x: 8, y: 4, w: 4, h: 3 }, kind: 'activity' },
            { id: 'l1', title: 'Recent registrations', layout: { x: 0, y: 7, w: 12, h: 3 }, kind: 'list', list: { formId: '@pack:event-registration', titleField: 'attendee_name', subtitleField: 'organization', limit: 6 } },
...
export default eventManagementPack;
