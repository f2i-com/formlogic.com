...
import transcriptIndexTsx from './aokie-screens/transcript/index.tsx?raw';
import transcriptSortTs from './aokie-screens/transcript/sort.ts?raw';
import transcriptCss from './aokie-screens/transcript/styles.css?raw';

// The ordering rule is shared source: the shipped file IS the tested module.
export { compareTurns } from './aokie-screens/transcript/sort';
