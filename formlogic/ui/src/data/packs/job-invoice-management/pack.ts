      ...
      customScreen: {
        ...
        dashboard: {
          ...
          widgets: [
            ...
            { id: 'k2', title: 'Client types', layout: { x: 3, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:client', viz: 'kpi', measure: { fn: 'countDistinct', field: 'client_type' } } },
            { id: 'c1', title: 'Clients by type', layout: { x: 6, y: 0, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:client', viz: 'donut', groupBy: { field: 'client_type', bucket: 'none' }, measure: { fn: 'count' }, seriesSort: 'value', sort: 'desc', limit: 6 } },
            { id: 'c2', title: 'New clients over time', layout: { x: 0, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:client', viz: 'area', groupBy: { field: '__submitted_at', bucket: 'month' }, measure: { fn: 'count' }, seriesSort: 'label', limit: 12 } },
            { id: 'l1', title: 'Recent clients', layout: { x: 0, y: 4, w: 12, h: 3 }, kind: 'list', list: { formId: '@pack:client', titleField: 'business_name', subtitleField: 'client_type', limit: 6 } },
          ],
        },
      },
    },
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          widgets: [
            ...
            { id: 'c1', title: 'Jobs by stage', layout: { x: 0, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:job', viz: 'bar', groupBy: { field: 'status', bucket: 'none' }, measure: { fn: 'count' }, seriesSort: 'value', sort: 'desc', limit: 8 } },
            { id: 'c2', title: 'Jobs by service type', layout: { x: 6, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:job', viz: 'donut', groupBy: { field: 'service_type', bucket: 'none' }, measure: { fn: 'count' }, seriesSort: 'value', sort: 'desc', limit: 6 } },
            { id: 'l1', title: 'Recent jobs', layout: { x: 0, y: 4, w: 12, h: 3 }, kind: 'list', list: { formId: '@pack:job', titleField: 'title', subtitleField: 'status', limit: 6 } },
          ],
        },
      },
    },
    ...
    // ── 3. Quote ──────────────────────────────────────────────────────────
    {
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          cols: 12,
          widgets: [
            { id: 'k1', title: 'Total quotes', layout: { x: 0, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:quote', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k2', title: 'Quoted value', layout: { x: 3, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:quote', viz: 'kpi', measure: { fn: 'sum', field: 'total' } } },
            { id: 'k3', title: 'Avg quote', layout: { x: 6, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:quote', viz: 'kpi', measure: { fn: 'avg', field: 'total' } } },
            { id: 'c1', title: 'Quotes by status', layout: { x: 0, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:quote', viz: 'bar', groupBy: { field: 'status', bucket: 'none' }, measure: { fn: 'count' }, seriesSort: 'value', sort: 'desc', limit: 6 } },
            { id: 'c2', title: 'Quoted value over time', layout: { x: 6, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:quote', viz: 'area', groupBy: { field: '__submitted_at', bucket: 'month' }, measure: { fn: 'sum', field: 'total' }, seriesSort: 'label', limit: 12 } },
            { id: 'l1', title: 'Recent quotes', layout: { x: 0, y: 4, w: 12, h: 3 }, kind: 'list', list: { formId: '@pack:quote', titleField: 'quote_number', subtitleField: 'status', limit: 6 } },
          ],
        },
      },
    },
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          widgets: [
            ...
            { id: 'k2', title: 'Total invoiced', layout: { x: 3, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:invoice', viz: 'kpi', measure: { fn: 'sum', field: 'amount' } } },
            { id: 'k3', title: 'Total collected', layout: { x: 6, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:invoice', viz: 'kpi', measure: { fn: 'sum', field: 'amount_paid' } } },
            { id: 'c1', title: 'Invoices by status', layout: { x: 0, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:invoice', viz: 'bar', groupBy: { field: 'status', bucket: 'none' }, measure: { fn: 'count' }, seriesSort: 'value', sort: 'desc', limit: 6 } },
    ...
    // ── 5. Payment ────────────────────────────────────────────────────────
    {
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          cols: 12,
          widgets: [
            { id: 'k1', title: 'Total payments', layout: { x: 0, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:payment', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k2', title: 'Total collected', layout: { x: 3, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:payment', viz: 'kpi', measure: { fn: 'sum', field: 'amount' } } },
            { id: 'k3', title: 'Avg payment', layout: { x: 6, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:payment', viz: 'kpi', measure: { fn: 'avg', field: 'amount' } } },
            { id: 'c1', title: 'Payments by method', layout: { x: 0, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:payment', viz: 'donut', groupBy: { field: 'method', bucket: 'none' }, measure: { fn: 'count' }, seriesSort: 'value', sort: 'desc', limit: 6 } },
            { id: 'c2', title: 'Payments over time', layout: { x: 6, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:payment', viz: 'area', groupBy: { field: '__submitted_at', bucket: 'month' }, measure: { fn: 'sum', field: 'amount' }, seriesSort: 'label', limit: 12 } },
            { id: 'l1', title: 'Recent payments', layout: { x: 0, y: 4, w: 12, h: 3 }, kind: 'list', list: { formId: '@pack:payment', titleField: 'reference', subtitleField: 'method', limit: 6 } },
          ],
        },
      },
    },
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          widgets: [
            ...
            { id: 'k3', title: 'Total invoiced', layout: { x: 6, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:invoice', viz: 'kpi', measure: { fn: 'sum', field: 'amount' } } },
            { id: 'k4', title: 'Collected', layout: { x: 9, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:payment', viz: 'kpi', measure: { fn: 'sum', field: 'amount' } } },
            { id: 'c1', title: 'Revenue over time', layout: { x: 0, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:invoice', viz: 'line', groupBy: { field: '__submitted_at', bucket: 'month' }, measure: { fn: 'sum', field: 'amount' }, seriesSort: 'label', limit: 12 } },
            { id: 'c2', title: 'Pipeline by stage', layout: { x: 6, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:job', viz: 'bar', groupBy: { field: 'status', bucket: 'none' }, measure: { fn: 'sum', field: 'estimated_value' }, seriesSort: 'value', sort: 'desc', limit: 8 } },
            { id: 'l1', title: 'Recent invoices', layout: { x: 0, y: 4, w: 6, h: 3 }, kind: 'list', list: { formId: '@pack:invoice', titleField: 'invoice_number', subtitleField: 'status', limit: 6 } },
            { id: 'a2', title: 'Recent activity', layout: { x: 6, y: 4, w: 6, h: 3 }, kind: 'activity' },
