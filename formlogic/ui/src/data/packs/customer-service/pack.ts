    ...
    // ── 1. Support Ticket ─────────────────────────────────────────────────
    {
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          cols: 12,
          widgets: [
            { id: 'k1', title: 'Total tickets', layout: { x: 0, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:support-ticket', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k2', title: 'Urgent tickets', layout: { x: 3, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:support-ticket', viz: 'kpi', measure: { fn: 'count' }, filters: [{ field: 'priority', op: 'eq', value: 'urgent' }] } },
            { id: 'c1', title: 'Tickets by category', layout: { x: 6, y: 0, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:support-ticket', viz: 'donut', groupBy: { field: 'category', bucket: 'none' }, measure: { fn: 'count' }, limit: 8 } },
            { id: 'c2', title: 'Tickets by priority', layout: { x: 0, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:support-ticket', viz: 'bar', groupBy: { field: 'priority', bucket: 'none' }, measure: { fn: 'count' }, seriesSort: 'value', sort: 'desc', limit: 6 } },
            { id: 'c3', title: 'Tickets over time', layout: { x: 0, y: 4, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:support-ticket', viz: 'area', groupBy: { field: '__submitted_at', bucket: 'month' }, measure: { fn: 'count' }, seriesSort: 'label', limit: 12 } },
            { id: 'l1', title: 'Recent tickets', layout: { x: 6, y: 4, w: 6, h: 3 }, kind: 'list', list: { formId: '@pack:support-ticket', titleField: 'subject', subtitleField: 'customer_name', limit: 6 } },
          ],
        },
      },
    },
    ...
    // ── 2. Bug Report ─────────────────────────────────────────────────────
    {
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          cols: 12,
          widgets: [
            { id: 'k1', title: 'Total bugs', layout: { x: 0, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:bug-report', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k2', title: 'Critical bugs', layout: { x: 3, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:bug-report', viz: 'kpi', measure: { fn: 'count' }, filters: [{ field: 'severity', op: 'eq', value: 'critical' }] } },
            { id: 'c1', title: 'Bugs by severity', layout: { x: 6, y: 0, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:bug-report', viz: 'donut', groupBy: { field: 'severity', bucket: 'none' }, measure: { fn: 'count' }, limit: 6 } },
            { id: 'c2', title: 'Bugs by product', layout: { x: 0, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:bug-report', viz: 'bar', groupBy: { field: 'product', bucket: 'none' }, measure: { fn: 'count' }, seriesSort: 'value', sort: 'desc', limit: 8 } },
            { id: 'c3', title: 'Bug reports over time', layout: { x: 0, y: 4, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:bug-report', viz: 'area', groupBy: { field: '__submitted_at', bucket: 'month' }, measure: { fn: 'count' }, seriesSort: 'label', limit: 12 } },
            { id: 'l1', title: 'Recent bug reports', layout: { x: 6, y: 4, w: 6, h: 3 }, kind: 'list', list: { formId: '@pack:bug-report', titleField: 'bug_title', subtitleField: 'product', limit: 6 } },
          ],
        },
      },
    },
    ...
    // ── 3. Feature Request ────────────────────────────────────────────────
    {
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          cols: 12,
          widgets: [
            { id: 'k1', title: 'Total requests', layout: { x: 0, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:feature-request', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k2', title: 'Avg business impact', layout: { x: 3, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:feature-request', viz: 'kpi', measure: { fn: 'avg', field: 'impact' } } },
            { id: 'k3', title: 'Critical requests', layout: { x: 6, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:feature-request', viz: 'kpi', measure: { fn: 'count' }, filters: [{ field: 'priority', op: 'eq', value: 'critical' }] } },
            { id: 'c1', title: 'Requests by priority', layout: { x: 0, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:feature-request', viz: 'bar', groupBy: { field: 'priority', bucket: 'none' }, measure: { fn: 'count' }, seriesSort: 'value', sort: 'desc', limit: 6 } },
            { id: 'c2', title: 'Requests over time', layout: { x: 6, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:feature-request', viz: 'area', groupBy: { field: '__submitted_at', bucket: 'month' }, measure: { fn: 'count' }, seriesSort: 'label', limit: 12 } },
            { id: 'l1', title: 'Recent requests', layout: { x: 0, y: 4, w: 12, h: 3 }, kind: 'list', list: { formId: '@pack:feature-request', titleField: 'feature_title', subtitleField: 'priority', limit: 8 } },
          ],
        },
      },
    },
    ...
    // ── 4. Customer Feedback Survey ───────────────────────────────────────
    {
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          cols: 12,
          widgets: [
            { id: 'k1', title: 'Total responses', layout: { x: 0, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:customer-feedback', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k2', title: 'Avg CSAT (/5)', layout: { x: 3, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:customer-feedback', viz: 'kpi', measure: { fn: 'avg', field: 'overall_satisfaction' } } },
            { id: 'k3', title: 'Avg NPS (/10)', layout: { x: 6, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:customer-feedback', viz: 'kpi', measure: { fn: 'avg', field: 'nps_score' } } },
            { id: 'k4', title: 'Avg agent rating', layout: { x: 9, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:customer-feedback', viz: 'kpi', measure: { fn: 'avg', field: 'agent_rating' } } },
            { id: 'c1', title: 'CSAT by ticket category', layout: { x: 0, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:customer-feedback', viz: 'bar', joins: [{ via: 'ticket_record', formId: '@pack:support-ticket', type: 'left' }], groupBy: { field: '@pack:support-ticket::category', bucket: 'none' }, measure: { fn: 'avg', field: 'overall_satisfaction' }, seriesSort: 'value', sort: 'desc', limit: 8 } },
            { id: 'c2', title: 'Would use support again', layout: { x: 6, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:customer-feedback', viz: 'donut', groupBy: { field: 'would_recommend', bucket: 'none' }, measure: { fn: 'count' }, limit: 3 } },
            { id: 'l1', title: 'Recent feedback', layout: { x: 0, y: 4, w: 12, h: 3 }, kind: 'list', list: { formId: '@pack:customer-feedback', titleField: 'comments', subtitleField: 'would_recommend', limit: 6 } },
          ],
        },
      },
    },
    ...
    // ── 5. Refund / Return Request ────────────────────────────────────────
    {
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          cols: 12,
          widgets: [
            { id: 'k1', title: 'Total requests', layout: { x: 0, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:refund-request', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k2', title: 'Total refund value', layout: { x: 3, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:refund-request', viz: 'kpi', measure: { fn: 'sum', field: 'amount' } } },
            { id: 'k3', title: 'Avg refund', layout: { x: 6, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:refund-request', viz: 'kpi', measure: { fn: 'avg', field: 'amount' } } },
            { id: 'c1', title: 'Requests by reason', layout: { x: 0, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:refund-request', viz: 'bar', groupBy: { field: 'reason', bucket: 'none' }, measure: { fn: 'count' }, seriesSort: 'value', sort: 'desc', limit: 8 } },
            { id: 'c2', title: 'Refund method share', layout: { x: 6, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:refund-request', viz: 'donut', groupBy: { field: 'refund_method', bucket: 'none' }, measure: { fn: 'count' }, limit: 4 } },
            { id: 'c3', title: 'Refund value over time', layout: { x: 0, y: 4, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:refund-request', viz: 'area', groupBy: { field: '__submitted_at', bucket: 'month' }, measure: { fn: 'sum', field: 'amount' }, seriesSort: 'label', limit: 12 } },
            { id: 'l1', title: 'Recent requests', layout: { x: 6, y: 4, w: 6, h: 3 }, kind: 'list', list: { formId: '@pack:refund-request', titleField: 'order_number', subtitleField: 'reason', limit: 6 } },
          ],
        },
      },
    },
    ...
    // ── 6. Escalation Form ────────────────────────────────────────────────
    {
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          cols: 12,
          widgets: [
            { id: 'k1', title: 'Total escalations', layout: { x: 0, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:escalation-form', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k2', title: 'Critical', layout: { x: 3, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:escalation-form', viz: 'kpi', measure: { fn: 'count' }, filters: [{ field: 'urgency', op: 'eq', value: 'critical' }] } },
            { id: 'k3', title: 'High urgency', layout: { x: 6, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:escalation-form', viz: 'kpi', measure: { fn: 'count' }, filters: [{ field: 'urgency', op: 'eq', value: 'high' }] } },
            { id: 'c1', title: 'Escalations by reason', layout: { x: 0, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:escalation-form', viz: 'bar', groupBy: { field: 'escalation_reason', bucket: 'none' }, measure: { fn: 'count' }, seriesSort: 'value', sort: 'desc', limit: 8 } },
            { id: 'c2', title: 'Escalations by urgency', layout: { x: 6, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:escalation-form', viz: 'donut', groupBy: { field: 'urgency', bucket: 'none' }, measure: { fn: 'count' }, limit: 4 } },
            { id: 'c3', title: 'Escalations over time', layout: { x: 0, y: 4, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:escalation-form', viz: 'area', groupBy: { field: '__submitted_at', bucket: 'month' }, measure: { fn: 'count' }, seriesSort: 'label', limit: 12 } },
            { id: 'l1', title: 'Recent escalations', layout: { x: 6, y: 4, w: 6, h: 3 }, kind: 'list', list: { formId: '@pack:escalation-form', titleField: 'escalated_to', subtitleField: 'escalation_reason', limit: 6 } },
          ],
        },
      },
    },
    ...
    // ── 7. Knowledge Base Entry ───────────────────────────────────────────
    {
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          cols: 12,
          widgets: [
            { id: 'k1', title: 'Total articles', layout: { x: 0, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:knowledge-base-entry', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k2', title: 'Published', layout: { x: 3, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:knowledge-base-entry', viz: 'kpi', measure: { fn: 'count' }, filters: [{ field: 'status', op: 'eq', value: 'published' }] } },
            { id: 'k3', title: 'Needs review', layout: { x: 6, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:knowledge-base-entry', viz: 'kpi', measure: { fn: 'count' }, filters: [{ field: 'status', op: 'eq', value: 'needs_review' }] } },
            { id: 'c1', title: 'Articles by category', layout: { x: 0, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:knowledge-base-entry', viz: 'bar', groupBy: { field: 'category', bucket: 'none' }, measure: { fn: 'count' }, seriesSort: 'value', sort: 'desc', limit: 8 } },
            { id: 'c2', title: 'Articles by status', layout: { x: 6, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:knowledge-base-entry', viz: 'donut', groupBy: { field: 'status', bucket: 'none' }, measure: { fn: 'count' }, limit: 4 } },
            { id: 'l1', title: 'Recent articles', layout: { x: 0, y: 4, w: 12, h: 3 }, kind: 'list', list: { formId: '@pack:knowledge-base-entry', titleField: 'title', subtitleField: 'category', limit: 8 } },
          ],
        },
      },
    },
  ...
  apps: [
    {
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          cols: 12,
          widgets: [
            { id: 'k1', title: 'Support tickets', layout: { x: 0, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:support-ticket', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k2', title: 'Bug reports', layout: { x: 3, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:bug-report', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k3', title: 'Escalations', layout: { x: 6, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:escalation-form', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k4', title: 'Refund value', layout: { x: 9, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:refund-request', viz: 'kpi', measure: { fn: 'sum', field: 'amount' } } },
            { id: 'c1', title: 'Tickets by priority', layout: { x: 0, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:support-ticket', viz: 'bar', groupBy: { field: 'priority', bucket: 'none' }, measure: { fn: 'count' }, seriesSort: 'value', sort: 'desc', limit: 6 } },
            { id: 'c2', title: 'Tickets over time', layout: { x: 6, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:support-ticket', viz: 'area', groupBy: { field: '__submitted_at', bucket: 'month' }, measure: { fn: 'count' }, seriesSort: 'label', limit: 12 } },
            { id: 'a1', title: 'Quick actions', layout: { x: 0, y: 4, w: 12, h: 1 }, kind: 'actions' },
            { id: 'l1', title: 'Recent tickets', layout: { x: 0, y: 5, w: 8, h: 3 }, kind: 'list', list: { formId: '@pack:support-ticket', titleField: 'subject', subtitleField: 'customer_name', limit: 8 } },
            { id: 'ac1', title: 'Recent activity', layout: { x: 8, y: 5, w: 4, h: 3 }, kind: 'activity' },
          ],
        },
      },
      roles: [
...
export default customerServicePack;
