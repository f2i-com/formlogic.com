...
import deviceIndexTsx from './device-setup/index.tsx?raw';
import deviceBridgeTs from './device-setup/bridge.ts?raw';
import deviceFormatTs from './device-setup/format.ts?raw';
import deviceTypesTs from './device-setup/types.ts?raw';
import deviceLoadingTsx from './device-setup/components/Loading.tsx?raw';
import deviceRuntimeCardTsx from './device-setup/components/RuntimeCard.tsx?raw';
import deviceDonglesCardTsx from './device-setup/components/DonglesCard.tsx?raw';
import devicePhonesCardTsx from './device-setup/components/PhonesCard.tsx?raw';
import deviceCompanionCardTsx from './device-setup/components/CompanionCard.tsx?raw';
