...
import settingsIndexTsx from './receptionist-settings/index.tsx?raw';
import settingsStoreTs from './receptionist-settings/store.ts?raw';
...
import advancedCardTsx from './receptionist-settings/components/AdvancedCard.tsx?raw';
import saveBarTsx from './receptionist-settings/components/SaveBar.tsx?raw';
