...
// SIBLING SURFACE NOTE: the desktop's compiled Configure-receptionist panel
// (formlogic/desktop/src/aokie/aokieSettings.ts) used to carry a COPY of these
// pure helpers, cross-imported here and parity-locked test-by-test. That
// compiled desktop UI is GONE — the Aokie plugin now ships its own desktop
// screen inside its pack (aokie repo, ui/receptionist/tabs/settings.js), so
// the sibling voice picker lives there and parity is maintained by CONVENTION
// (same ttsVoiceCatalog contract, same option sets, same write targets), not
// by a cross-repo import this suite can reach.
