          ...
          widgets: [
            {
              ...
              kind: 'report',
              spec: { formId: '@pack:patient', viz: 'kpi', measure: { fn: 'count' } },
            },
            {
              id: 't1',
              title: 'Patient register',
              layout: { x: 3, y: 0, w: 9, h: 1 },
              kind: 'text',
              text: {
                body: 'Everyone registered at the front desk. Register a patient to book appointments and capture intake.',
              },
            },
            {
              id: 'c1',
            ...
            },
            {
              ...
              kind: 'list',
              list: { formId: '@pack:patient', titleField: 'full_name', subtitleField: 'phone', limit: 6 },
            },
          ],
        },
      },
          ...
          widgets: [
            {
              ...
              layout: { x: 0, y: 0, w: 3, h: 1 },
              kind: 'report',
              spec: { formId: '@pack:provider', viz: 'kpi', measure: { fn: 'count' } },
            },
            {
              id: 'k2',
              ...
              kind: 'report',
              spec: { formId: '@pack:provider', viz: 'kpi', measure: { fn: 'countDistinct', field: 'role' } },
            },
            {
              id: 'c1',
              ...
              kind: 'report',
              spec: {
                formId: '@pack:provider',
                viz: 'donut',
                groupBy: { field: 'role', bucket: 'none' },
                measure: { fn: 'count' },
                limit: 6,
              },
            },
            {
              id: 'c2',
              title: 'Providers added over time',
              layout: { x: 0, y: 1, w: 6, h: 3 },
              kind: 'report',
              spec: {
                formId: '@pack:provider',
            ...
            },
            {
              ...
              kind: 'list',
              list: { formId: '@pack:provider', titleField: 'full_name', subtitleField: 'role', limit: 6 },
            },
          ],
        },
      },
          ...
          widgets: [
            {
              ...
              layout: { x: 0, y: 0, w: 3, h: 1 },
              kind: 'report',
              spec: { formId: '@pack:appointment', viz: 'kpi', measure: { fn: 'count' } },
            },
            {
              id: 'k2',
              title: 'Patients seen',
              layout: { x: 3, y: 0, w: 3, h: 1 },
              kind: 'report',
              spec: { formId: '@pack:appointment', viz: 'kpi', measure: { fn: 'countDistinct', field: 'patient' } },
            },
            {
              id: 'c2',
              ...
              spec: {
                ...
                viz: 'donut',
                groupBy: { field: 'appt_type', bucket: 'none' },
                measure: { fn: 'count' },
                limit: 6,
              },
            },
            ...
            },
            {
              ...
              layout: { x: 6, y: 3, w: 6, h: 3 },
              kind: 'list',
              list: { formId: '@pack:appointment', titleField: 'appt_type', subtitleField: 'appt_date', limit: 6 },
            },
            {
              id: 'c3',
              title: 'Booked over time',
          ...
          widgets: [
            {
              ...
              layout: { x: 0, y: 0, w: 3, h: 1 },
              kind: 'report',
              spec: { formId: '@pack:intake-form', viz: 'kpi', measure: { fn: 'count' } },
            },
            {
              id: 'k2',
              title: 'Patients with intake',
              layout: { x: 3, y: 0, w: 3, h: 1 },
              kind: 'report',
              spec: { formId: '@pack:intake-form', viz: 'kpi', measure: { fn: 'countDistinct', field: 'patient' } },
            },
            {
              id: 'c1',
              ...
              kind: 'report',
              spec: {
                formId: '@pack:intake-form',
                viz: 'donut',
                groupBy: { field: 'preferred_contact', bucket: 'none' },
                measure: { fn: 'count' },
                limit: 6,
              },
            },
            ...
            },
            {
              ...
              layout: { x: 6, y: 3, w: 6, h: 3 },
              kind: 'list',
              list: { formId: '@pack:intake-form', titleField: 'reason_for_visit', subtitleField: 'preferred_contact', limit: 6 },
            },
          ],
        },
      },
          ...
          widgets: [
            {
              ...
              layout: { x: 0, y: 0, w: 3, h: 1 },
              kind: 'report',
              spec: { formId: '@pack:follow-up', viz: 'kpi', measure: { fn: 'count' } },
            },
            {
              id: 'k2',
              title: 'Appointments covered',
              layout: { x: 3, y: 0, w: 3, h: 1 },
              kind: 'report',
              spec: { formId: '@pack:follow-up', viz: 'kpi', measure: { fn: 'countDistinct', field: 'appointment' } },
            },
            {
              id: 'c1',
              title: 'By status',
            ...
            },
            {
              ...
              layout: { x: 6, y: 3, w: 6, h: 3 },
              kind: 'list',
              list: { formId: '@pack:follow-up', titleField: 'action', subtitleField: 'status', limit: 6 },
            },
          ],
        },
      },
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          widgets: [
            ...
            {
              id: 'c2',
              title: 'Appointments booked over time',
              layout: { x: 6, y: 1, w: 6, h: 3 },
              kind: 'report',
              spec: {
                formId: '@pack:appointment',
            ...
            },
            {
              ...
              kind: 'list',
              list: { formId: '@pack:appointment', titleField: 'appt_type', subtitleField: 'appt_date', limit: 8 },
            },
            {
              id: 'act1',
...
export default clinicIntakePack;
