...
The public `/packs` gallery and details use the shared landing navigation/footer. A
credential-free starter catalogue is generated by `scripts/emit-marketplace.mjs`.
