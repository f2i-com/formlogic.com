...
per-mode selection, the reply channel and the author-message rewrite — is host code and stays in
FormLogic. The document is generated by `formlogic/ui/scripts/build-script-profile.mjs` from the
