  ...
  apps: [
    {
      ...
      customScreen: {
        ...
        js: [
          ...
          "  var html='<div class=\"wrap\">';",
          "  html+=headerBlock(HH,ctx.appName||'SitePulse',brief(['<b>'+fmtInt(openDef)+'</b> open defects','<b>'+fmtInt(diaWeek)+'</b> diaries this week','<b>'+mnyC(appVal)+'</b> approved variations',expList.length?'<b>'+fmtInt(expList.length)+'</b> insurance expiring':'']),[{nav:fD?fD.formId:'',label:'New diary entry',icon:I.plus},{nav:fX?fX.formId:'',label:'Log defect',icon:I.alert,ghost:true}]);",
          "  html+='<div class=\"kpis\">'",
          ...
          "  var pcCounts=countBy(defects,'priority'),pcMax=0,pi;",
