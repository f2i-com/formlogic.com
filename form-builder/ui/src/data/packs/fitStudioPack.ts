      ...
      customScreen: {
        ...
        dashboard: {
          ...
          widgets: [
            ...
            { id: 'c2', title: 'Revenue over time', layout: { x: 6, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:payment', viz: 'area', groupBy: { field: 'date', bucket: 'month' }, measure: { fn: 'sum', field: 'amount' }, filters: [{ field: 'status', op: 'eq', value: 'paid' }], seriesSort: 'label', limit: 12 } },
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          widgets: [
            ...
            { id: 'c1', title: 'Revenue over time', layout: { x: 0, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:payment', viz: 'area', groupBy: { field: 'date', bucket: 'month' }, measure: { fn: 'sum', field: 'amount' }, filters: [{ field: 'status', op: 'eq', value: 'paid' }], seriesSort: 'label', limit: 12 } },
