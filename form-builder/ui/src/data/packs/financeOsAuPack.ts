    ...
    // ── 1. New Client Onboarding ─────────────────────────────────────────
    {
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          cols: 12,
          widgets: [
            { id: 'k1', title: 'Clients', layout: { x: 0, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:au-client-intake', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k2', title: 'Net assets', layout: { x: 3, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:au-client-intake', viz: 'kpi', measure: { fn: 'sum', field: 'net_assets' } } },
            { id: 'k3', title: 'Avg risk tolerance', layout: { x: 6, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:au-client-intake', viz: 'kpi', measure: { fn: 'avg', field: 'risk_tolerance' } } },
            { id: 'k4', title: 'Avg annual income', layout: { x: 9, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:au-client-intake', viz: 'kpi', measure: { fn: 'avg', field: 'annual_income' } } },
            { id: 'c1', title: 'Clients by objective', layout: { x: 0, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:au-client-intake', viz: 'bar', groupBy: { field: 'investment_objectives', bucket: 'none' }, measure: { fn: 'count' }, seriesSort: 'value', sort: 'desc', limit: 8 } },
            { id: 'c2', title: 'Residency mix', layout: { x: 6, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:au-client-intake', viz: 'donut', groupBy: { field: 'residency_status', bucket: 'none' }, measure: { fn: 'count' }, limit: 6 } },
            { id: 'c3', title: 'New clients over time', layout: { x: 0, y: 4, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:au-client-intake', viz: 'area', groupBy: { field: '__submitted_at', bucket: 'month' }, measure: { fn: 'count' }, seriesSort: 'label', limit: 12 } },
            { id: 'l1', title: 'Recent clients', layout: { x: 6, y: 4, w: 6, h: 3 }, kind: 'list', list: { formId: '@pack:au-client-intake', titleField: 'first_name', subtitleField: 'residency_status', limit: 6 } },
          ],
        },
      },
      fields: [
    ...
    // ── 2. Risk Profile Assessment ──────────────────────────────────────
    {
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          cols: 12,
          widgets: [
            { id: 'k1', title: 'Assessments', layout: { x: 0, y: 0, w: 4, h: 1 }, kind: 'report', spec: { formId: '@pack:au-risk-questionnaire', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k2', title: 'Avg loss capacity', layout: { x: 4, y: 0, w: 4, h: 1 }, kind: 'report', spec: { formId: '@pack:au-risk-questionnaire', viz: 'kpi', measure: { fn: 'avg', field: 'loss_capacity' } } },
            { id: 'k3', title: 'Avg time horizon', layout: { x: 8, y: 0, w: 4, h: 1 }, kind: 'report', spec: { formId: '@pack:au-risk-questionnaire', viz: 'kpi', measure: { fn: 'avg', field: 'time_horizon' } } },
            { id: 'c1', title: 'Recommended profiles', layout: { x: 0, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:au-risk-questionnaire', viz: 'bar', groupBy: { field: 'recommended_profile', bucket: 'none' }, measure: { fn: 'count' }, seriesSort: 'value', sort: 'desc', limit: 8 } },
            { id: 'c2', title: 'Investment experience', layout: { x: 6, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:au-risk-questionnaire', viz: 'donut', groupBy: { field: 'investment_experience', bucket: 'none' }, measure: { fn: 'count' }, limit: 6 } },
            { id: 'c3', title: 'Assessments over time', layout: { x: 0, y: 4, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:au-risk-questionnaire', viz: 'area', groupBy: { field: '__submitted_at', bucket: 'month' }, measure: { fn: 'count' }, seriesSort: 'label', limit: 12 } },
            { id: 'l1', title: 'Recent assessments', layout: { x: 6, y: 4, w: 6, h: 3 }, kind: 'list', list: { formId: '@pack:au-risk-questionnaire', titleField: 'recommended_profile', subtitleField: 'investment_experience', limit: 6 } },
          ],
        },
      },
      fields: [
    ...
    // ── 3. Off-Market Transfer ───────────────────────────────────────────
    {
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          cols: 12,
          widgets: [
            { id: 'k1', title: 'Transfers', layout: { x: 0, y: 0, w: 4, h: 1 }, kind: 'report', spec: { formId: '@pack:au-off-market-transfer', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k2', title: 'Value in motion', layout: { x: 4, y: 0, w: 4, h: 1 }, kind: 'report', spec: { formId: '@pack:au-off-market-transfer', viz: 'kpi', measure: { fn: 'sum', field: 'estimated_value' } } },
            { id: 'k3', title: 'Avg transfer value', layout: { x: 8, y: 0, w: 4, h: 1 }, kind: 'report', spec: { formId: '@pack:au-off-market-transfer', viz: 'kpi', measure: { fn: 'avg', field: 'estimated_value' } } },
            { id: 'c1', title: 'Delivering platforms', layout: { x: 0, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:au-off-market-transfer', viz: 'bar', groupBy: { field: 'delivering_platform', bucket: 'none' }, measure: { fn: 'count' }, seriesSort: 'value', sort: 'desc', limit: 8 } },
            { id: 'c2', title: 'Transfer type', layout: { x: 6, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:au-off-market-transfer', viz: 'donut', groupBy: { field: 'transfer_type', bucket: 'none' }, measure: { fn: 'count' }, limit: 6 } },
            { id: 'c3', title: 'Transfer value over time', layout: { x: 0, y: 4, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:au-off-market-transfer', viz: 'area', groupBy: { field: '__submitted_at', bucket: 'month' }, measure: { fn: 'sum', field: 'estimated_value' }, seriesSort: 'label', limit: 12 } },
            { id: 'l1', title: 'Recent transfers', layout: { x: 6, y: 4, w: 6, h: 3 }, kind: 'list', list: { formId: '@pack:au-off-market-transfer', titleField: 'account_reference', subtitleField: 'delivering_platform', limit: 6 } },
          ],
        },
      },
      fields: [
    ...
    // ── 4. Financial Services Guide Acknowledgement ──────────────────────
    {
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          cols: 12,
          widgets: [
            { id: 'k1', title: 'Acknowledgements', layout: { x: 0, y: 0, w: 4, h: 1 }, kind: 'report', spec: { formId: '@pack:au-fsg-acknowledgement', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'c1', title: 'Signing cadence', layout: { x: 0, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:au-fsg-acknowledgement', viz: 'area', groupBy: { field: 'acknowledgement_date', bucket: 'month' }, measure: { fn: 'count' }, seriesSort: 'label', limit: 12 } },
            { id: 'c2', title: 'New records over time', layout: { x: 6, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:au-fsg-acknowledgement', viz: 'area', groupBy: { field: '__submitted_at', bucket: 'month' }, measure: { fn: 'count' }, seriesSort: 'label', limit: 12 } },
            { id: 'l1', title: 'Recent acknowledgements', layout: { x: 0, y: 4, w: 12, h: 3 }, kind: 'list', list: { formId: '@pack:au-fsg-acknowledgement', titleField: 'acknowledgement_date', limit: 6 } },
          ],
        },
      },
      fields: [
    ...
    // ── 5. Annual Client Review ──────────────────────────────────────────
    {
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          cols: 12,
          widgets: [
            { id: 'k1', title: 'Reviews', layout: { x: 0, y: 0, w: 4, h: 1 }, kind: 'report', spec: { formId: '@pack:au-annual-review', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k2', title: 'Portfolio under review', layout: { x: 4, y: 0, w: 4, h: 1 }, kind: 'report', spec: { formId: '@pack:au-annual-review', viz: 'kpi', measure: { fn: 'sum', field: 'current_portfolio_value' } } },
            { id: 'k3', title: 'Avg goal progress', layout: { x: 8, y: 0, w: 4, h: 1 }, kind: 'report', spec: { formId: '@pack:au-annual-review', viz: 'kpi', measure: { fn: 'avg', field: 'goal_progress' } } },
            { id: 'c1', title: 'Life changes reported', layout: { x: 0, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:au-annual-review', viz: 'bar', groupBy: { field: 'life_changes', bucket: 'none' }, measure: { fn: 'count' }, seriesSort: 'value', sort: 'desc', limit: 8 } },
            { id: 'c2', title: 'Portfolio value over time', layout: { x: 6, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:au-annual-review', viz: 'area', groupBy: { field: '__submitted_at', bucket: 'month' }, measure: { fn: 'sum', field: 'current_portfolio_value' }, seriesSort: 'label', limit: 12 } },
            { id: 'l1', title: 'Recent reviews', layout: { x: 0, y: 4, w: 12, h: 3 }, kind: 'list', list: { formId: '@pack:au-annual-review', titleField: 'current_portfolio_value', subtitleField: 'next_review_date', limit: 6 } },
          ],
        },
      },
      fields: [
    ...
    // ── 6. Fee Disclosure Statement ──────────────────────────────────────
    {
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          cols: 12,
          widgets: [
            { id: 'k1', title: 'Fee agreements', layout: { x: 0, y: 0, w: 4, h: 1 }, kind: 'report', spec: { formId: '@pack:au-fee-agreement', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k2', title: 'Funds under advice', layout: { x: 4, y: 0, w: 4, h: 1 }, kind: 'report', spec: { formId: '@pack:au-fee-agreement', viz: 'kpi', measure: { fn: 'sum', field: 'portfolio_value' } } },
            { id: 'k3', title: 'Avg portfolio', layout: { x: 8, y: 0, w: 4, h: 1 }, kind: 'report', spec: { formId: '@pack:au-fee-agreement', viz: 'kpi', measure: { fn: 'avg', field: 'portfolio_value' } } },
            { id: 'c1', title: 'Fee types', layout: { x: 0, y: 1, w: 4, h: 3 }, kind: 'report', spec: { formId: '@pack:au-fee-agreement', viz: 'donut', groupBy: { field: 'fee_type', bucket: 'none' }, measure: { fn: 'count' }, limit: 6 } },
            { id: 'c2', title: 'Billing frequency', layout: { x: 4, y: 1, w: 4, h: 3 }, kind: 'report', spec: { formId: '@pack:au-fee-agreement', viz: 'bar', groupBy: { field: 'billing_frequency', bucket: 'none' }, measure: { fn: 'count' }, seriesSort: 'value', sort: 'desc', limit: 8 } },
            { id: 'c3', title: 'Ongoing fee consent', layout: { x: 8, y: 1, w: 4, h: 3 }, kind: 'report', spec: { formId: '@pack:au-fee-agreement', viz: 'donut', groupBy: { field: 'ongoing_fee_consent', bucket: 'none' }, measure: { fn: 'count' }, limit: 6 } },
            { id: 'l1', title: 'Recent statements', layout: { x: 0, y: 4, w: 12, h: 3 }, kind: 'list', list: { formId: '@pack:au-fee-agreement', titleField: 'portfolio_value', subtitleField: 'billing_frequency', limit: 6 } },
          ],
        },
      },
      fields: [
    ...
    // ── 7. Document Vault ────────────────────────────────────────────────
    {
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          cols: 12,
          widgets: [
            { id: 'k1', title: 'Documents', layout: { x: 0, y: 0, w: 4, h: 1 }, kind: 'report', spec: { formId: '@pack:au-document-vault', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'c1', title: 'Documents by type', layout: { x: 0, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:au-document-vault', viz: 'bar', groupBy: { field: 'document_type', bucket: 'none' }, measure: { fn: 'count' }, seriesSort: 'value', sort: 'desc', limit: 8 } },
            { id: 'c2', title: 'Documents over time', layout: { x: 6, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:au-document-vault', viz: 'area', groupBy: { field: '__submitted_at', bucket: 'month' }, measure: { fn: 'count' }, seriesSort: 'label', limit: 12 } },
            { id: 'c3', title: 'Expiring documents', layout: { x: 0, y: 4, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:au-document-vault', viz: 'table', columns: ['document_name', 'document_type', 'expiry_date'], sort: { by: 'expiry_date', dir: 'asc' }, limit: 8 } },
            { id: 'l1', title: 'Recent documents', layout: { x: 6, y: 4, w: 6, h: 3 }, kind: 'list', list: { formId: '@pack:au-document-vault', titleField: 'document_name', subtitleField: 'document_type', limit: 6 } },
          ],
        },
      },
      fields: [
    ...
    // ── 8. TFN Declaration ───────────────────────────────────────────────
    {
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          cols: 12,
          widgets: [
            { id: 'k1', title: 'Declarations', layout: { x: 0, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:au-tfn-declaration', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'c1', title: 'Residency for tax', layout: { x: 0, y: 1, w: 4, h: 3 }, kind: 'report', spec: { formId: '@pack:au-tfn-declaration', viz: 'donut', groupBy: { field: 'residency_for_tax', bucket: 'none' }, measure: { fn: 'count' }, limit: 6 } },
            { id: 'c2', title: 'TFN exemption', layout: { x: 4, y: 1, w: 4, h: 3 }, kind: 'report', spec: { formId: '@pack:au-tfn-declaration', viz: 'donut', groupBy: { field: 'tfn_exemption', bucket: 'none' }, measure: { fn: 'count' }, limit: 6 } },
            { id: 'c3', title: 'HELP / study loans', layout: { x: 8, y: 1, w: 4, h: 3 }, kind: 'report', spec: { formId: '@pack:au-tfn-declaration', viz: 'donut', groupBy: { field: 'has_hecs_help', bucket: 'none' }, measure: { fn: 'count' }, limit: 6 } },
            { id: 'c4', title: 'Declarations over time', layout: { x: 0, y: 4, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:au-tfn-declaration', viz: 'area', groupBy: { field: '__submitted_at', bucket: 'month' }, measure: { fn: 'count' }, seriesSort: 'label', limit: 12 } },
            { id: 'l1', title: 'Recent declarations', layout: { x: 6, y: 4, w: 6, h: 3 }, kind: 'list', list: { formId: '@pack:au-tfn-declaration', titleField: 'residency_for_tax', subtitleField: 'tfn_exemption', limit: 6 } },
          ],
        },
      },
      fields: [
    ...
    // ── 9. Binding Death Benefit Nomination ──────────────────────────────
    {
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          cols: 12,
          widgets: [
            { id: 'k1', title: 'Nominations', layout: { x: 0, y: 0, w: 4, h: 1 }, kind: 'report', spec: { formId: '@pack:au-bdbn', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k2', title: 'Avg primary allocation', layout: { x: 4, y: 0, w: 4, h: 1 }, kind: 'report', spec: { formId: '@pack:au-bdbn', viz: 'kpi', measure: { fn: 'avg', field: 'primary_percentage_1' } } },
            { id: 'c1', title: 'Primary beneficiary relationships', layout: { x: 0, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:au-bdbn', viz: 'bar', groupBy: { field: 'primary_relationship_1', bucket: 'none' }, measure: { fn: 'count' }, seriesSort: 'value', sort: 'desc', limit: 8 } },
            { id: 'c2', title: 'Nominations over time', layout: { x: 6, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:au-bdbn', viz: 'area', groupBy: { field: '__submitted_at', bucket: 'month' }, measure: { fn: 'count' }, seriesSort: 'label', limit: 12 } },
            { id: 'l1', title: 'Recent nominations', layout: { x: 0, y: 4, w: 12, h: 3 }, kind: 'list', list: { formId: '@pack:au-bdbn', titleField: 'super_fund_name', subtitleField: 'member_number', limit: 6 } },
          ],
        },
      },
      fields: [
    ...
    // ── 10. Superannuation Rollover ──────────────────────────────────────
    {
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          cols: 12,
          widgets: [
            { id: 'k1', title: 'Rollovers', layout: { x: 0, y: 0, w: 4, h: 1 }, kind: 'report', spec: { formId: '@pack:au-super-rollover', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k2', title: 'Balance in motion', layout: { x: 4, y: 0, w: 4, h: 1 }, kind: 'report', spec: { formId: '@pack:au-super-rollover', viz: 'kpi', measure: { fn: 'sum', field: 'estimated_balance' } } },
            { id: 'k3', title: 'Avg balance', layout: { x: 8, y: 0, w: 4, h: 1 }, kind: 'report', spec: { formId: '@pack:au-super-rollover', viz: 'kpi', measure: { fn: 'avg', field: 'estimated_balance' } } },
            { id: 'c1', title: 'Preservation status', layout: { x: 0, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:au-super-rollover', viz: 'donut', groupBy: { field: 'preservation_status', bucket: 'none' }, measure: { fn: 'count' }, limit: 6 } },
            { id: 'c2', title: 'Rollover type', layout: { x: 6, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:au-super-rollover', viz: 'donut', groupBy: { field: 'rollover_type', bucket: 'none' }, measure: { fn: 'count' }, limit: 6 } },
            { id: 'c3', title: 'Balance over time', layout: { x: 0, y: 4, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:au-super-rollover', viz: 'area', groupBy: { field: '__submitted_at', bucket: 'month' }, measure: { fn: 'sum', field: 'estimated_balance' }, seriesSort: 'label', limit: 12 } },
            { id: 'l1', title: 'Recent rollovers', layout: { x: 6, y: 4, w: 6, h: 3 }, kind: 'list', list: { formId: '@pack:au-super-rollover', titleField: 'to_fund_name', subtitleField: 'from_fund_name', limit: 6 } },
          ],
        },
      },
      fields: [
    ...
    // ── 1. Client Onboarding (Australia) ─────────────────────────────────
    {
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          widgets: [
            { id: 'k1', title: 'Clients', layout: { x: 0, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:au-client-intake', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k2', title: 'Risk assessments', layout: { x: 3, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:au-risk-questionnaire', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k3', title: 'FSG signed', layout: { x: 6, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:au-fsg-acknowledgement', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k4', title: 'Documents on file', layout: { x: 9, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:au-document-vault', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'c1', title: 'Clients by objective', layout: { x: 0, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:au-client-intake', viz: 'bar', groupBy: { field: 'investment_objectives', bucket: 'none' }, measure: { fn: 'count' }, seriesSort: 'value', sort: 'desc', limit: 8 } },
            { id: 'c2', title: 'New clients over time', layout: { x: 6, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:au-client-intake', viz: 'area', groupBy: { field: '__submitted_at', bucket: 'month' }, measure: { fn: 'count' }, seriesSort: 'label', limit: 12 } },
            { id: 'a1', title: 'Quick actions', layout: { x: 0, y: 4, w: 12, h: 1 }, kind: 'actions' },
            { id: 'l1', title: 'Recent clients', layout: { x: 0, y: 5, w: 8, h: 3 }, kind: 'list', list: { formId: '@pack:au-client-intake', titleField: 'first_name', subtitleField: 'residency_status', limit: 6 } },
    ...
    // ── 2. Portfolio Management Hub (Australia) ──────────────────────────
    {
      ...
      customScreen: {
        ...
        dashboard: {
          ...
          widgets: [
            { id: 'k1', title: 'Clients', layout: { x: 0, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:au-client-intake', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k2', title: 'Funds under review', layout: { x: 3, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:au-annual-review', viz: 'kpi', measure: { fn: 'sum', field: 'current_portfolio_value' } } },
            { id: 'k3', title: 'Fee agreements', layout: { x: 6, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:au-fee-agreement', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'k4', title: 'Super rollovers', layout: { x: 9, y: 0, w: 3, h: 1 }, kind: 'report', spec: { formId: '@pack:au-super-rollover', viz: 'kpi', measure: { fn: 'count' } } },
            { id: 'c1', title: 'Portfolio value over time', layout: { x: 0, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:au-annual-review', viz: 'area', groupBy: { field: '__submitted_at', bucket: 'month' }, measure: { fn: 'sum', field: 'current_portfolio_value' }, seriesSort: 'label', limit: 12 } },
            { id: 'c2', title: 'Transfers by platform', layout: { x: 6, y: 1, w: 6, h: 3 }, kind: 'report', spec: { formId: '@pack:au-off-market-transfer', viz: 'donut', groupBy: { field: 'delivering_platform', bucket: 'none' }, measure: { fn: 'count' }, limit: 6 } },
            { id: 'l1', title: 'Recent reviews', layout: { x: 0, y: 4, w: 8, h: 3 }, kind: 'list', list: { formId: '@pack:au-annual-review', titleField: 'current_portfolio_value', subtitleField: 'next_review_date', limit: 6 } },
