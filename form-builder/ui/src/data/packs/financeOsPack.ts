  ...
  apps: [
    // ── 1. Client Onboarding Navigator ───────────────────────────────────
    {
      ...
      customScreen: {
        ...
        css: [
          ':root{--accent:#4f46e5;--accent2:#818cf8;--ink:#e2e8f0;--muted:#94a3b8;--line:rgba(148,163,184,0.14);}',
          '*{box-sizing:border-box;}html,body{margin:0;padding:0;}',
          'body{font-family:system-ui,-apple-system,"Segoe UI",Roboto,sans-serif;color:var(--ink);background:#0f172a;background-image:radial-gradient(1100px 520px at 12% -12%,rgba(79,70,229,0.24),transparent 60%),radial-gradient(880px 460px at 108% 4%,rgba(129,140,248,0.12),transparent 58%);background-attachment:fixed;-webkit-font-smoothing:antialiased;}',
          ...
          '.title{margin:0;font-size:26px;line-height:1.15;font-weight:800;letter-spacing:-0.02em;color:#f8fafc;}',
          '.who{margin-top:9px;font-size:13px;color:var(--muted);}.who b{color:#cbd5e1;font-weight:600;}',
          ...
          '.btn-primary{background:var(--accent);color:#fff;box-shadow:0 8px 22px -8px rgba(79,70,229,0.75);}.btn-primary:hover{filter:brightness(1.08);}',
          '.stats{display:grid;grid-template-columns:repeat(5,1fr);gap:13px;margin-bottom:22px;}',
          '.stat{background:rgba(30,41,59,0.6);border:1px solid var(--line);border-radius:15px;padding:16px 15px;}',
          '.stat-val{font-size:25px;font-weight:800;letter-spacing:-0.02em;color:#f8fafc;line-height:1.1;}',
          '.stat-label{margin-top:7px;font-size:12.5px;font-weight:600;color:#cbd5e1;}',
          '.stat-sub{margin-top:3px;font-size:11px;color:var(--muted);}',
          '.grid2{display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:16px;}',
          '.panel{background:rgba(30,41,59,0.5);border:1px solid var(--line);border-radius:16px;padding:18px 18px 20px;}',
          '.panel h3{margin:0 0 15px;font-size:13.5px;font-weight:700;color:#f1f5f9;}',
          ...
          '.bar-name{font-size:12.5px;color:#cbd5e1;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;}',
          '.bar-track{height:9px;border-radius:6px;background:rgba(148,163,184,0.15);overflow:hidden;}',
          ...
          '.row{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:11px 0;border-top:1px solid rgba(148,163,184,0.1);}.row:first-child{border-top:0;padding-top:0;}',
          '.row-main{min-width:0;}',
          '.row-title{font-size:13.5px;font-weight:600;color:#f1f5f9;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;}',
          '.row-sub{margin-top:3px;font-size:11.5px;color:var(--muted);}',
          '.row-r{text-align:right;white-space:nowrap;}',
          '.amt{font-size:13.5px;font-weight:700;color:#f1f5f9;margin-bottom:4px;}',
          ...
          '.act{display:flex;align-items:center;gap:11px;text-align:left;background:rgba(30,41,59,0.5);border:1px solid var(--line);color:var(--ink);border-radius:12px;padding:13px 14px;cursor:pointer;font:inherit;font-weight:600;font-size:13.5px;transition:border-color .15s ease,transform .05s ease;}',
          '.act:hover{border-color:var(--accent);}.act:active{transform:translateY(1px);}',
          '.act .ico{width:32px;height:32px;flex:none;display:grid;place-items:center;border-radius:9px;background:rgba(79,70,229,0.18);font-size:16px;}',
        ...
        js: [
          ...
          "    for (var c=0;c<n;c++){ var a = clients[c].answers || {}; var nm = ((a.first_name||'')+' '+(a.last_name||'')).trim() || 'Unnamed client'; var isAcc = String(a.accredited_investor||'').toLowerCase() === 'yes'; var rs = a.risk_score; var bdg = isAcc ? badge('Accredited', '#34d399', 'rgba(16,185,129,0.16)') : badge('Standard', '#cbd5e1', 'rgba(148,163,184,0.16)'); var sub = fmtDate(clients[c].submittedAt) + ((rs != null && rs !== '') ? (' \\u00b7 Risk '+h(rs)) : ''); recent += '<div class=\"row\"><div class=\"row-main\"><div class=\"row-title\">'+h(nm)+'</div><div class=\"row-sub\">'+sub+'</div></div><div class=\"row-r\">'+bdg+'</div></div>'; }",
          "    recent += '</div>';",
          "  }",
    ...
    // ── 2. Advisor Transition Hub ────────────────────────────────────────
    {
      ...
      customScreen: {
        ...
        css: [
          ':root{--accent:#059669;--accent2:#34d399;--ink:#e2e8f0;--muted:#94a3b8;--line:rgba(148,163,184,0.14);}',
          '*{box-sizing:border-box;}html,body{margin:0;padding:0;}',
          'body{font-family:system-ui,-apple-system,"Segoe UI",Roboto,sans-serif;color:var(--ink);background:#0f172a;background-image:radial-gradient(1100px 520px at 12% -12%,rgba(5,150,105,0.24),transparent 60%),radial-gradient(880px 460px at 108% 4%,rgba(52,211,153,0.12),transparent 58%);background-attachment:fixed;-webkit-font-smoothing:antialiased;}',
          '.wrap{max-width:1080px;margin:0 auto;padding:30px 22px 60px;}',
          '.empty{text-align:center;padding:96px 20px;color:var(--muted);font-size:14px;}',
          '.hdr{display:flex;align-items:flex-start;justify-content:space-between;gap:16px;flex-wrap:wrap;margin-bottom:26px;}',
          '.hdr-l{min-width:0;}',
          ...
          '.who{margin-top:9px;font-size:13px;color:var(--muted);}.who b{color:#cbd5e1;font-weight:600;}',
          '.btn{appearance:none;border:0;cursor:pointer;font:inherit;border-radius:11px;padding:11px 17px;font-weight:650;font-size:14px;}',
          '.btn-primary{background:var(--accent);color:#fff;box-shadow:0 8px 22px -8px rgba(5,150,105,0.75);}.btn-primary:hover{filter:brightness(1.08);}',
          '.stats{display:grid;grid-template-columns:repeat(5,1fr);gap:13px;margin-bottom:22px;}',
          '.stat{background:rgba(30,41,59,0.6);border:1px solid var(--line);border-radius:15px;padding:16px 15px;}',
          '.stat-val{font-size:25px;font-weight:800;letter-spacing:-0.02em;color:#f8fafc;line-height:1.1;}',
          '.stat-label{margin-top:7px;font-size:12.5px;font-weight:600;color:#cbd5e1;}',
          ...
          '.act{display:flex;align-items:center;gap:11px;text-align:left;background:rgba(30,41,59,0.5);border:1px solid var(--line);color:var(--ink);border-radius:12px;padding:13px 14px;cursor:pointer;font:inherit;font-weight:600;font-size:13.5px;transition:border-color .15s ease,transform .05s ease;}',
          '.act:hover{border-color:var(--accent);}.act:active{transform:translateY(1px);}',
          '.act .ico{width:32px;height:32px;flex:none;display:grid;place-items:center;border-radius:9px;background:rgba(5,150,105,0.18);font-size:16px;}',
          '.empty-sm{color:var(--muted);font-size:13px;padding:12px 0;}',
          '.empty-cta{padding-top:6px;}',
          '.link-btn{background:none;border:0;color:var(--accent2);cursor:pointer;font:inherit;font-weight:650;font-size:13px;padding:6px 0;}.link-btn:hover{text-decoration:underline;}',
          '@media(max-width:900px){.stats{grid-template-columns:repeat(3,1fr);}.grid2{grid-template-columns:1fr;}}',
        ...
        js: [
          ...
          "    for (var c=0;c<n;c++){ var a = acat[c].answers || {}; var cust = labelFor(custMap, a.custodian); var tt = String(a.transfer_type||'').toLowerCase(); var bdg = tt === 'full' ? badge('Full', '#34d399', 'rgba(16,185,129,0.16)') : (tt === 'partial' ? badge('Partial', '#fbbf24', 'rgba(251,191,36,0.16)') : badge(labelFor(ttMap, a.transfer_type), '#cbd5e1', 'rgba(148,163,184,0.16)')); recent += '<div class=\"row\"><div class=\"row-main\"><div class=\"row-title\">'+h(cust)+'</div><div class=\"row-sub\">'+fmtDate(acat[c].submittedAt)+'</div></div><div class=\"row-r\"><div class=\"amt\">'+moneyC(Number(a.estimated_value)||0)+'</div>'+bdg+'</div></div>'; }",
          "    recent += '</div>';",
          "  }",
