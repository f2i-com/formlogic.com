...
/**
 * Copy text to the clipboard. The async Clipboard API only works in secure contexts (HTTPS/localhost),
 * so fall back to a hidden-textarea + execCommand for plain-HTTP deployments. Returns true on success.
 */
