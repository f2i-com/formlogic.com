            ...
            {fieldsByCategory[category]?.map((field) => {
              ...
              return (
                <button
                  ...
                  title={field.label}
                  className="flex items-center gap-2 p-3 sm:p-2 text-left text-sm rounded-lg border border-gray-200 dark:border-slate-700 hover:border-primary-500/50 hover:bg-primary-50 dark:hover:bg-primary-500/10 active:scale-95 transition-all cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500"
                >
                  <IconComponent className="h-4 w-4 text-gray-500 dark:text-slate-500 flex-shrink-0" />
