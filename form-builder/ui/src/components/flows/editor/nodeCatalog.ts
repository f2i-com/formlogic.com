    ...
    properties: [
      {
        ...
        help: 'Boolean over { inputs, event, app, nodes, upstream }. Runs in QuickJS — never eval.',
      },
    ],
  },
  {
    ...
    properties: [
      {
        ...
        help: 'Return a JSON value. Wall clock capped (2s default; data.timeoutMs 100ms–30s).',
      },
