...
interface AppRuntimeState {
  ...
  // Response CRUD
  fetchResponses: (formId: string, options?: { limit?: number; offset?: number; resolve?: boolean; answersEq?: Record<string, string>; answersPhoneEq?: Record<string, string> }) => Promise<unknown[]>;
